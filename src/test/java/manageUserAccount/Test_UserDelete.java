...
public class Test_UserDelete extends BaseTest{

	
	@Test(dataProvider="getData", groups="ManageUserAccount")
	public void testUserDeleteSuccess(HashMap<String, String> input) {
		// Login/Signup page
		...
		LandingPage deleteAccount = login.deleteAccount();
